...
//
//     final editJobDataModel = editJobDataModelFromJson(jsonString);

import 'dart:convert';

EditJobDataModel editJobDataModelFromJson(String str) =>
    EditJobDataModel.fromJson(json.decode(str));

String editJobDataModelToJson(EditJobDataModel data) =>
...
class EditJobDataModel {
  ...
  factory EditJobDataModel.fromJson(Map<String, dynamic> json) =>
      EditJobDataModel(
